 ...
 *                                                                          *
 *  AIC3204_init                                                            *
 *      AIC3204 initiaization                                               *
 *                                                                          *
 * ------------------------------------------------------------------------ */
unsigned long aic3204_init_and_set_fs_and_gain(unsigned long SamplingFrequency, unsigned int ADCgain)
{
    ...
    switch (SamplingFrequency)
    {
     ...
     default:
     	PLLPR = 0x91; // 1001 0001b. PLL on. P = 1, R = 1. 
     	printf("Sampling frequency not recognised. Default value used.\n");
     	output = 48000;  
     break;
    }
    printf("Sampling frequency = %ld Hz;  Gain = %d dB\n", output, ADCgain);
...
//    AIC3204_rset( 5, 0x91 );   // PLL setting: Power up PLL, P=1 and R=1
    AIC3204_rset( 5, PLLPR );   // PLL setting: Power up PLL, 
...
//    AIC3204_rset( 65, 0 );     // Left DAC gain to 0dB VOL; Right tracks Left
    AIC3204_rset( 65, 2*12 );  // Left DAC gain to 12dB VOL; Right tracks Left
